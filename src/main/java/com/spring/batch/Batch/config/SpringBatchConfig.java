...
import com.spring.batch.Batch.listener.StepSkipListener;
import com.spring.batch.Batch.partition.ColumnRangePartition;
...
public class SpringBatchConfig {
    ...
    @Autowired
    private CustomerWriter customerItemWriter;
